...
export default function HRMessaging() {
  ...
  const [conversations] = useState<Conversation[]>([
    {
      id: "1",
      participants: ["Admin", "HR Manager"],
      lastMessage: "Please review the new worker assignments for Zone A",
      lastMessageTime: "2024-01-15 10:30",
      unreadCount: 2,
      subject: "Zone A Worker Assignments",
    },
    {
      id: "2",
      participants: ["ZI Officer", "HR Manager"],
      lastMessage: "Attendance report for last week has been submitted",
      lastMessageTime: "2024-01-14 15:45",
      unreadCount: 0,
    ...
    },
    {
      id: "3",
      participants: ["Admin", "HR Manager"],
      lastMessage: "Worker request #WR001 has been approved",
      lastMessageTime: "2024-01-13 09:15",
      unreadCount: 1,
      subject: "Worker Request Approval",
    },
  ])
  ...
  const [messages] = useState<Message[]>([
    {
      ...
      subject: "Zone A Worker Assignments",
      content:
        "Please review the new worker assignments for Zone A. We need to ensure proper coverage for all feeder points.",
    ...
    },
    {
      ...
      subject: "Weekly Attendance Report",
      content:
        "The weekly attendance report has been compiled and is ready for your review. Overall attendance is at 92%.",
            ...
            <List.Item
              ...
              right={(props) => (
                <View {...props} style={styles.messageRight}>
                  ...
                  {message.status === "unread" && <MaterialCommunityIcons name="circle" size={8} color="#2196F3" />}
                </View>
              )}
                ...
                {["low", "medium", "high"].map((priority) => (
                  <Chip
                    ...
                    style={[
                      ...
                      {
                        backgroundColor: newMessage.priority === priority ? getPriorityColor(priority) : "#E3F2FD",
                      },
                    ]}
                    textStyle={{
